...
import com.simsek.cryptocrazytwo.ui.theme.RichBlack
import com.simsek.cryptocrazytwo.viewmodel.CryptoListViewModel
...
//onSearch, search barı kullandığımda arama yapıldığında bana kod bloğu açıcak ve aramayı string olarak verecek
//repositoryden veya viewModel dan searchi çağırabilecek

//by diyerek direkt olarak değeri alabiliyoruz
    ...
    Box(modifier = modifier){
        BasicTextField(value = text, onValueChange = {
            ...
            modifier = Modifier
                ...
                .onFocusChanged {
                    //kullanıcı searchbara tıklamıyorsa ve boşsa hint gösterilecek
...
//list_item.xml gibi düşün
//listede görünecek kısmı tasarlardık
@Composable
